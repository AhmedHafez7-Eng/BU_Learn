            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="content col-9">
                        ...
                        <h2><a href="#">Computer Graphics, BFCI, Spring 2019: Faculty of Computers and<br>Informatics Benha.</a></h2>
                        <hr style="border: 0.5px solid lightgrey">
                        <section class="detail">
                            <details>
                                    <summary>Text Book</summary>
                                    <ul>
                                        <li><a href="files/CG/ARpresence.pdf">
                                            Computer Graphics Book</a></li>
                                    </ul>
                            </details>
                            <hr>
                            ...
                            <details>
                                    ...
                                    <ul>
                                        <li>
                                            <a href="files/CG/CG_Lec_2.pdf">
                                            Lec 2</a>
                                        </li>
                                        <li>
                                            <a href="files/CG/CG_Lec_3.pdf">
                                            Lec 3</a>
                                        </li>
                                        <li>
                                            <a href="files/CG/CG_Lec_4.pdf">
                                            Lec 4</a>
                                        </li>
                                        <li>
                                            <a href="files/CG/CG_Lec_5.pdf">
                                            Lec 5</a>
                                        </li>
                                        <li>
                                            <a href="files/CG/CG_Lec_6.pdf">
                                            Lec 6</a>
                                        </li>
                                        <li>
                                            <a href="files/CG/CG_Lec_7.pdf">
                                            Lec 7</a>
                                        </li>
                                        <li>
                                            <a href="files/CG/CG_Lec_8.pdf">
                                            Lec 8</a>
                                        </li>
                                        <li>
                                            <a href="files/CG/CG_Lec_10.pdf">
                                            Lec 10</a>
                                        </li>
                                    </ul>
                            </details>
                            ...
                            <details>
                                    ...
                                    <ul>
                                        <li><a href="files/CG/sec%2001%20Introduction%20to%20Computer%20Graphic.pptx">
                                            Lab 1</a></li>
                                        <li><a href="files/CG/sec%2002%20Drawing%20some%20basic%20primitives.pptx">
                                            Lab 2</a></li>
                                        <li><a href="files/CG/sec%2003%202D%20Animation%20,Coloring%20and%20translation.pptx">
                                            Lab 3</a></li>
                                        <li><a href="files/CG/sec%2004%20Handling%20Keyboard%20Inputs%20and%20Mouse%20Inputs.pptx">
                                            Lab 4</a></li>
                                    </ul>
                            </details>
                            <hr>
                            <details>
                                    ...
                                    <ul>
                                        <li><a href="files/CG/asignment.txt">
                                            Assignment1</a></li>
                                        <li><a href="files/CG/Assignment1.txt">
                                            Assignment2</a></li>
                                    </ul>
                            </details>
                            <hr>
